...
if (!ISSET($_SESSION['category_master1']) || $_SESSION['category_master1'] != "yes") {
	die("Access Denied");
}
?>
...
//  Matt Brown
//************************************************************************************************************
if (OpenGridForm("", "leave_category_master")) {
...
function DefineFields() {
  ...
  $oForm->AddEntryField("category_id", "ID", "B", "<auto>");
  ...
  $oForm->AddEntryField("allow_negative_balance", "Neg Bal", "T", "");
  $oForm->CurrentField["width"]=150;

  $oForm->AddEntryField("allow_balance_carry_forward", "Carry Forward", "T", "");
  $oForm->CurrentField["width"]=120;

  $oForm->AddEntryField("paid_unpaid", "Paid/Unpaid", "T", "");
  $oForm->CurrentField["width"]=120;

  $oForm->AddEntryField("auto_approve", "Auto Approve", "T", "");
  $oForm->CurrentField["width"]=120;
